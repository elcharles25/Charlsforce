...
try {
  ...
  if ($results.Count -eq 0) {
    [System.IO.File]::WriteAllText('C:\\Users\\candresd\\Downloads\\nurture-rocket-crm-main\\backend\\temp\\inbox_465125d0-cc1b-41a2-b637-9c792acb9ad5.json', '[]', $utf8NoBom)
  } else {
    $json = $results | ConvertTo-Json -Depth 3 -Compress
    [System.IO.File]::WriteAllText('C:\\Users\\candresd\\Downloads\\nurture-rocket-crm-main\\backend\\temp\\inbox_465125d0-cc1b-41a2-b637-9c792acb9ad5.json', $json, $utf8NoBom)
  }
