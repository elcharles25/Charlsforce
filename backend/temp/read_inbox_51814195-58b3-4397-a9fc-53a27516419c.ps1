...
try {
  ...
  if ($results.Count -eq 0) {
    [System.IO.File]::WriteAllText('C:\\Users\\candresd\\Downloads\\nurture-rocket-crm-main\\backend\\temp\\inbox_ed212a38-574f-4bd9-b37f-f4df723547b5.json', '[]', $utf8NoBom)
  } else {
    $json = $results | ConvertTo-Json -Depth 3 -Compress
    [System.IO.File]::WriteAllText('C:\\Users\\candresd\\Downloads\\nurture-rocket-crm-main\\backend\\temp\\inbox_ed212a38-574f-4bd9-b37f-f4df723547b5.json', $json, $utf8NoBom)
  }
